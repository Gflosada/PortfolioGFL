        ...
        <div className="relative px-4 py-3 rounded-full bg-zinc-800/80 backdrop-blur-md border border-zinc-700/50 shadow-lg">
          ...
          {isMobile ? (
            ...
            <div className="relative flex items-center gap-1">
              ...
              <Button
                size="sm"
                className="ml-2 bg-gradient-to-r from-slate-600 to-blue-600 hover:from-blue-600 hover:to-slate-600 border-0"
              >
      ...
      {isMobile && (
        ...
        >
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <Button className="mt-6 bg-gradient-to-r from-slate-600 to-blue-600 hover:from-blue-600 hover:to-slate-600 border-0">
              <Link href="/ResumeGL .docx.pdf" download className="relative z-10 flex items-center">
                Download Resume
              </Link>
            </Button>
